                                        ...
                                        <div class="pad">
                                            ...
                                            <p>
                                                <button class="btn btn-default btn-sm"><i
                                                        class="fa fa-cloud-download"></i> Generate PDF</button>
                                            </p>
                                        </div><!-- /.pad -->
                                    </div><!-- /.col -->
                                </div><!-- /.row - inside box -->
                    ...
                    <section class="col-lg-6 connectedSortable">
                        ...
                        <div class="box box-success">
                            ...
                            <div class="box-body chat" id="chat-box">
                                <!-- chat item -->
                                <div class="item">
                                    <img src="<?php echo base_url("public/img/avatar.png") ?>" alt="user image"
                                        class="online" />
                                    <p class="message">
                                        <a href="#" class="name">
                                ...
                                <!-- chat item -->
                                <div class="item">
                                    <img src="<?php echo base_url("public/img/avatar2.png") ?>" alt="user image"
                                        class="offline" />
                                    <p class="message">
                                        <a href="#" class="name">
                                            <small class="text-muted pull-right"><i class="fa fa-clock-o"></i>
                                ...
                                <!-- chat item -->
                                <div class="item">
                                    <img src="<?php echo base_url("public/img/avatar3.png") ?>" alt="user image"
                                        class="offline" />
                                    <p class="message">
                                        <a href="#" class="name">
                                            <small class="text-muted pull-right"><i class="fa fa-clock-o"></i>
        ...
        <!-- Sparkline -->
        <script src="<?php echo base_url("public/js/plugins/sparkline/jquery.sparkline.min.js") ?>"
            type="text/javascript">
        </script>
        <!-- jvectormap -->
        <script src="<?php echo base_url("public/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js") ?>"
            type="text/javascript"></script>
        <script src="<?php echo base_url("public/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js") ?>"
            type="text/javascript"></script>
        <!-- fullCalendar -->
        <script src="<?php echo base_url("public/js/plugins/fullcalendar/fullcalendar.min.js") ?>"
            type="text/javascript">
        </script>
        <!-- jQuery Knob Chart -->
        <script src="<?php echo base_url("public/js/plugins/jqueryKnob/jquery.knob.js") ?>" type="text/javascript">
        </script>
        <!-- daterangepicker -->
        <script src="<?php echo base_url("public/js/plugins/daterangepicker/daterangepicker.js") ?>"
            type="text/javascript">
        </script>
        <!-- Bootstrap WYSIHTML5 -->
        <script src="<?php echo base_url("public/js/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js") ?>"
            type="text/javascript"></script>
        <!-- iCheck -->
