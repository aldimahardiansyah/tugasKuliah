...
<div class="judul_rekreasi" style="margin-top: -35px;">
    ...
    <div class="bintang ml-5">
        ...
        <div style="display:flex;">
            <input id="rating" type="text" /> <span style="font-size: 2em; margin-top:0.2em; margin-left:0.3em;">
                <?= $wisata->bintang ?> </span>
        </div>
    </div>
        ...
        <div class="card-body">
            <blockquote class="blockquote ml-5 mr-5 mb-0">
                <p><?php foreach ($gambar as $foto) { ?>
                    <img src="<?= base_url('public/assets/upload/');
                                    echo $foto['nama'] ?>" width="190px" alt="gambar <?= $wisata->nama; ?>">
                    <?php } ?>
                </p>
            </blockquote>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between flex-wrap">
                            ...
                            <div>
                                ...
                                function initialize() {
                                    var propertiPeta = {
                                        center: new google.maps.LatLng(<?= $wisata->latitude ?>,
                                            <?= $wisata->longitude ?>),
                                        zoom: 14,
    ...
    <br>
    <?php if ($testi) {
        echo '<div class="judul_testimoni">
        <h4>Testimoni & Komentar</h4><br/>
    </div>';
    } ?>
    ...
    <div class="row mt-2">
        ...
        <div class="col ml-4">
            ...
            <div>
                <img src="<?= $testimoni->foto ?>" width="110px"
                    style="float:left; margin-right:1em; border-radius:12px;" />
                <h6><?= $testimoni->nama ?> - <?= $testimoni->profesi ?></h6>
