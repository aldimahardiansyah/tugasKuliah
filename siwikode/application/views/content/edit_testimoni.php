...
<section style="margin-top: -35px; margin-bottom: 50px;">
    ...
    <form style="margin: 20px;" method="POST" action="../update/<?= $testi->id ?>">
        <div class="form-group row">
            ...
            <div class="col-8">
                <div class="input-group">
                    ...
                    <input value="<?= $testi->nama ?>" id="nama" name="nama" type="text" class="form-control"
                        required="required">
                </div>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-8">
                <div class="input-group">
                    ...
                    <input value="<?= $testi->rating ?>" id="rating" name="rating" placeholder="1 - 5" type="number"
                        class="form-control" min='1' max='5' required="required">
                </div>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-8">
                <textarea id="testimoni" name="testimoni" cols="40" rows="5" class="form-control"
                    required="required"><?= $testi->komentar ?></textarea>
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-8">
                <div class="input-group">
                    ...
                    <input value="<?= $testi->foto ?>" id="foto" name="foto" placeholder="Masukkan link foto"
        ...
        <div class="form-group row">
            ...
            <div class="col-8">
                <select id="wisata" name="wisata" class="custom-select" required="required">
                    ...
                    <option value="<?= $wst->id ?>" <?php
                                                        if ($wst->nama == $testi->wisata) {
                                                            echo 'selected';
                                                        } ?>><?= $wst->nama ?></option>
                    <?php } ?>
                </select>
